...
The search space of SEGMENTATION-Adelaide-EA-NAS is defined in vega/search_space/networks/pytorch/customs/adelaide_nn, and the corresponding backbone implementation code is also stored in this directory. The operator mainly includes:
