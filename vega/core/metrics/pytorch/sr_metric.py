...
class SRMetric(MetricBase):
    ...
    def __init__(self, method='psnr', to_y=True, crop_border=0, scale=2, max_rgb=1):
        # crop_boarder has the same effect as scale, keep crop_border for interface consistency
        self.method = method
        self.to_y = to_y
        self.sum = 0.
        self.pfm = 0.
